...
public class PathFinder
{
    ...
    public PathFinder(int height, int width, float cellSize, Vector3 originPosition)
    {
    ...
    public int calculateMoveCost(PathGridNode a, PathGridNode b)
    {
        ...
        return MOVE_STRAIGHT_COST * straightDistance + MOVE_DIAGONAL_COST * Mathf.Min(distanceX, distanceY);
    }
}
